...
const DetailsPayment = ({ showSidebar }) => {
    ...
    useEffect(() => {
        window.document.title = t('details payment title')
    }, [i18n.language])
                        ...
                        <div className='mt-2'>
                            <div className='mt-4 space-y-16'>
                                <div className='flex items-center justify-between'>
                                    <div>
                                        <h2 className='text-2xl font-bold'>{t('details payment')} - {payment.name}</h2>
                                    </div>
                                ...
                                <div className='grid grid-cols-3 place-items-center'>
                                    <div className='space-y-8 font-semibold col-span-1'>
                                        <h3>{t('payment name')}</h3>
                                        <h3>{t('payment description')}</h3>
